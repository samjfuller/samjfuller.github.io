...
Project links include articles, preprints, and replication materials where publicly available.
...
:::::::::::::::::::: project-list
::::: project-card
### Unbundling Support for Political Violence

::: project-meta
Under review at APSR · September 2026 · with Jack T. Rametta & Alexa Federice
:::

Introduces a new set of batteries for measuring support for political violence that varies across actor$\rightarrow$target combinations; context and justification; and the severity of violent action.

::: pub-actions
[Preprint](https://osf.io/preprints/socarxiv/x86eh){.resource-link}
:::
:::::
...
Analyzes 54 datasets across the social sciences to identify predictors of support for political violence.
